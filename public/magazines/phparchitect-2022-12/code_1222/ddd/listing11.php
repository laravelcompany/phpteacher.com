...
namespace ...\ReportException\DomainModel\DataTransfer;
...
final class ExceptionReportEntity
{
  ...
  /**
   * Create array in correct format for
   * ExceptionReportsTable::newEntity()
   *
   * @return array
   */
  #[ArrayShape([
  ...
  {
    return [
      ExceptionReport::FIELD_DESC => $this->description,
